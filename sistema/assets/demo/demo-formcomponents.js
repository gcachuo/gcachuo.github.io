...
$(function() {
    ...
    /*$("#datepicker,#datepicker3,#datepicker5,#datepickerEntrega").datetimepicker();*/
	/*$("#datepickerEntrega").datetimepicker( "option", "yearRange", "-99:+0" );
    $("#datepickerEntrega").datetimepicker( "option", "maxDate", "+0m +0d" );*/
    $("#datepicker2").datepicker({dateFormat: "DD, d MM, yy"});
    $('#datepickerbtn2').click(function () {
        $('#datepicker2').datepicker("show");
    });
    $("#datepicker4").datepicker({ minDate: -3, maxDate: +4 });
    ...
    $(document).ready(function() {
		...
		$('#fechaReporteDescuentos').daterangepicker();
        $('#fechaReporte2').daterangepicker();	
    });
