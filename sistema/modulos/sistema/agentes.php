<?php
	...
	session_start();
	include_once('agentes_funciones.php');
	//DATOS DEL MODULO
	liberar_bd();
	...
	switch($_POST['accion'])
	{
		case 'Nuevo':
			...
			$modulo .= agentes_formularioUsuario('nuevo');
		break;
		
		case 'Editar':
			$_SESSION["moduloHijoActual"] = utf8_convertir($_POST['accion']);
			$modulo .= agentes_formularioUsuario('editar');
		break;
		
		case 'Guardar':
			$_SESSION["moduloHijoActual"] = utf8_convertir($_POST['accion']);
			$modulo.=agentes_guardaUsuario();
		break;
		...
		case 'Eliminar':
			$_SESSION["moduloHijoActual"] = utf8_convertir($_POST['accion']);
			$modulo.=agentes_eliminaUsuario();
		break;
			
		default:
			$modulo .= agentes_menuInicio();
		break;
