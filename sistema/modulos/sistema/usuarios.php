<?php
	...
	session_start();
	include_once('usuarios_funciones.php');
	//DATOS DEL MODULO
	liberar_bd();
	...
	switch($_POST['accion'])
	{
		case 'Nuevo':
			...
			$modulo .= usuarios_formularioUsuario('nuevo');
		break;
		
		case 'Editar':
			$_SESSION["moduloHijoActual"] = utf8_convertir($_POST['accion']);
			$modulo .= usuarios_formularioUsuario('editar');
		break;
		
		case 'Guardar':
			$_SESSION["moduloHijoActual"] = utf8_convertir($_POST['accion']);
			$modulo.=usuarios_guardaUsuario();
		break;
		...
		case 'Eliminar':
			$_SESSION["moduloHijoActual"] = utf8_convertir($_POST['accion']);
			$modulo.=usuarios_eliminaUsuario();
		break;
			
		default:
			$modulo .= usuarios_menuInicio();
		break;
